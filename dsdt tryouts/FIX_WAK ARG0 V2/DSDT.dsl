 ...
 *
 * Disassembly of DSDT.aml, Sat Mar  3 11:54:13 2018
 *
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x6AA16000, 0x073C)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x6A561F98, 0x10)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (HPET)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                If (HPTE)
                {
                    CreateDWordField (BUF0, \_SB.PCI0.LPCB.HPET._Y35._BAS, HPT0)  // _BAS: Base Address
                    Store (HPTB, HPT0)
                }
