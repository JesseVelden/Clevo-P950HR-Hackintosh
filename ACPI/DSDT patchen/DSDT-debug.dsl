 ...
 *
 * Disassembly of DSDT.aml, Wed May  2 23:47:08 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001DEE0 (122592)
 *     Revision         0x02
 *     Checksum         0x92
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
{
    /*
     * iASL Warning: There were 36 external control methods found during
     * disassembly, but only 31 were resolved (5 unresolved). Additional
    ...
    External (_SB_.PCI0.GFX0.CEVT, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CLID, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.GFX0.CSTS, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.GFX0.LDES, UnknownObj)    // (from opcode)
    ...
    External (_SB_.PCI0.PEG0.PEGP.LDES, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.NHDA, UnknownObj)    // (from opcode)
    External (_SB_.PCI0.PEG0.PEGP.PDID, UnknownObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x6A9FE000, 0x073C)
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0x6A549F98, 0x10)
...
RWAK (Arg0)
    ...
    Method (RWAK, 1, Serialized)
    {
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            {
                If (LEqual (\_SB.PCI0.LPCB.EC.ADP, One))
                {
                    Store (0x02, PRM1)
                    Store (0x0D, PRM0)
                    Store (0xE0, SSMP)
        ...
        If (LEqual (OSYS, 0x03E8))
        {
            \_SB.PCI0.SBUS.SWRB (0xE6, Zero, 0x82)
        }
        ...
        If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
        {
            ...
            If (\_SB.PCI0.LPCB.EC.ECOK)
            {
                ...
                If (LOr (LEqual (Arg0, 0x03), LEqual (Arg0, 0x04)))
                {
                    If (IGDS)
                    {
                        If (LEqual (\_SB.PCI0.LPCB.EC.LSTE, Zero))
                        {
                            Store (0x80000000, \_SB.PCI0.GFX0.CLID)
                        }

                        If (LEqual (\_SB.PCI0.LPCB.EC.LSTE, One))
                        {
                            Store (0x80000003, \_SB.PCI0.GFX0.CLID)
                        }

                        If (CondRefOf (\_SB.PCI0.GFX0.LDES))
                        {
                            Store (\_SB.PCI0.LPCB.EC.LSTE, \_SB.PCI0.GFX0.LDES)
                        }
                    }
                ...
                Store (\_SB.PCI0.LPCB.EC.ADP, PWRS)
            }
    ...
    Scope (_GPE)
    {
        ...
        Method (_L6F, 0, NotSerialized)  // _Lxx: Level-Triggered GPE
        {
            ...
            If (\_SB.ISME (0x01080000))
            {
                \_SB.CAGS (0x01080000)
                Wait (NVEV, 0xFFFF)
                Signal (NVEV)
                If (LEqual (\_SB.GGIV (0x01080000), One))
                {
                    If (LEqual (GPLK, Zero))
                    {
            ...
            If (\_SB.ISME (0x01080001))
            {
                ...
                Wait (NVEV, 0xFFFF)
                Signal (NVEV)
                If (LEqual (\_SB.GGIV (0x01080001), One))
                {
                    If (LEqual (GPLK, Zero))
                    {
                        Notify (\_SB.PCI0.PEG0.PEGP, 0x81)
            ...
            If (\_SB.ISME (0x01080002))
            {
                \_SB.CAGS (0x01080002)
                Wait (NVEV, 0xFFFF)
                Signal (NVEV)
                If (LEqual (\_SB.GGIV (0x01080002), One))
                {
                    If (LEqual (GPLK, Zero))
                    {
                        Notify (\_SB.PCI0.PEG0.PEGP, 0x81)
    ...
    Scope (_SB)
    {
        Scope (\_SB)
        {
            ...
            Device (PWRB)
            {
                ...
                Method (_PRW, 0, NotSerialized)  // _PRW: Power Resources for Wake
                {
                    Return (PKG2 (GGPE (0x01060007), 0x03))
                }
            }
            ...
            Device (WMI)
            {
                ...
                Method (GCMD, 3, Serialized)
                {
                    ...
                    If (LEqual (ToInteger (Arg1), One))
                    {
                        If (HKDR)
                        {
                            Store (EVNT, Local0)
                            Store (Zero, EVNT)
                            If (LEqual (^^PCI0.LPCB.EC.ESCF, One))
                            {
                                If (LEqual (^^PCI0.LPCB.EC.FBUF, 0xAA))
                                {
                                    Store (0x64, Local0)
                                }
                                ElseIf (LEqual (^^PCI0.LPCB.EC.FBUF, Zero))
                                {
                                    Store (0x65, Local0)
                                }

                                Store (0xFF, ^^PCI0.LPCB.EC.FBUF)
                                Store (Zero, ^^PCI0.LPCB.EC.ESCF)
                            }

                            If (LEqual (^^PCI0.LPCB.EC.NACT, One))
                            {
                                Store (0x68, Local0)
                            }
                            ElseIf (LEqual (^^PCI0.LPCB.EC.NACT, Zero))
                            {
                                If (LEqual (IDTF, One))
                                {
                                    Store (0x02, IDTF)
                    ...
                    If (LEqual (ToInteger (Arg1), 0x40))
                    {
                        Store (Zero, Local0)
                        Return (Local0)
                    }

                    If (LEqual (ToInteger (Arg1), 0x41))
                    {
                        Store (And (ShiftRight (ARGS, 0x18), 0xFF), ^^PCI0.LPCB.EC.FDAT)
                        Store (And (ShiftRight (ARGS, 0x10), 0xFF), ^^PCI0.LPCB.EC.FBUF)
                        Store (And (ShiftRight (ARGS, 0x08), 0xFF), ^^PCI0.LPCB.EC.FBF1)
                        Store (And (ARGS, 0xFF), ^^PCI0.LPCB.EC.FCMD)
                        Or (Local0, ^^PCI0.LPCB.EC.FDAT, Local0)
                        Or (Local0, ShiftLeft (^^PCI0.LPCB.EC.FBUF, 0x08), Local0)
                        Or (Local0, ShiftLeft (^^PCI0.LPCB.EC.FBF1, 0x10), Local0)
                        Or (Local0, ShiftLeft (^^PCI0.LPCB.EC.FBF2, 0x18), Local0)
                        Return (Local0)
                    }
                    ...
                    {
                        If (And (^^PCI0.LPCB.EC.RINF, 0x10))
                        {
                            Or (Local0, 0x40000000, PSF1)
                        }
                        Else
                        {
                            Or (Local0, 0x00400000, PSF1)
                        }
                ...
                Method (SCMD, 3, Serialized)
                {
                    ...
                    If (LEqual (ToInteger (Arg1), 0x4F))
                    {
                        ...
                        If (And (NVBB, 0xFFFF))
                        {
                            If (^^PCI0.LPCB.EC.ECOK)
                            {
                                ...
                                Else
                                {
                                    Store (Or (And (ShiftRight (NVBB, 0x04), 0xF0), And (NVBB, 0x0F)), ^^PCI0.LPCB.EC.BBST)
                                }
                            }
                        }
                    ...
                    If (LEqual (ToInteger (Arg1), 0x67))
                    {
                        ...
                        If (^^PCI0.LPCB.EC.ECOK)
                        {
                            ...
                            Else
                            {
                                ...
                                {
                                    Store (And (ShiftRight (ARGS, 0x0E), 0x1F), Local1)
                                    If (And (ARGS, 0x2000))
                                    {
                    ...
                    If (LEqual (ToInteger (Arg1), 0x75))
                    {
                        And (INDX, 0xFFFF, Local1)
                        And (ShiftRight (INDX, 0x10), 0xFFFF, Local2)
                        If (LEqual (Local1, 0xD9))
                        {
                            And (ARGS, 0xFFFFFF40, ARGS)
                            And (^^PCI0.LPCB.EC.AIRP, 0xBF, Local5)
                            Or (ARGS, Local5, ARGS)
                            Store (0xD9, P80H)
                        }
                    ...
                    If (LEqual (ToInteger (Arg1), 0x79))
                    {
                        ...
                        While (One)
                        {
                            ...
                            ElseIf (LEqual (_T_4, 0x0B))
                            {
                                Store (And (Local2, 0xFF), SVGA)
                                Store (0x0E, PRM0)
                                Store (0xE0, SSMP)
                            }
                            ElseIf (LEqual (_T_4, 0x0D))
                            {
                                While (One)
                                {
                            ...
                            ElseIf (LEqual (_T_4, 0x0E))
                            {
                                Store (And (Local2, 0xFF), ^^PCI0.LPCB.EC.XFAN)
                            }
                            ElseIf (LEqual (_T_4, 0x0F))
                            {
                            ...
                            ElseIf (LEqual (_T_4, 0x10))
                            {
                                ^^PCI0.SBUS.SWRB (0xE6, And (ShiftRight (Local2, 0x08), 0xFF), And (Local2, 0xFF))
                            }
                            ElseIf (LEqual (_T_4, 0x13))
                            {
                                If (PFBA)
                                {
                                    Add (PFBA, 0x02, Local1)
                                    ...
                                    Store (And (ARGS, 0xFFFF), BUPD)
                                    Store (0x0F, PRM0)
                                    Store (0xE0, SSMP)
                                }
                            }
                            ElseIf (LEqual (_T_4, 0x15))
                            {
                                If (^^PCI0.LPCB.EC.ECOK)
                                {
                                    Store (Local2, ^^PCI0.LPCB.EC.FDAT)
                                    Store (0xD3, ^^PCI0.LPCB.EC.FCMD)
                                }
                                Else
                                {
                                    Store (Ones, Local0)
                            ...
                            ElseIf (LEqual (_T_4, 0x17))
                            {
                                If (LEqual (^^PCI0.LPCB.EC.NACT, One))
                                {
                                    While (One)
                                    {
                                        ...
                                        {
                                            Store (Local2, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD5, ^^PCI0.LPCB.EC.FCMD)
                                            Store (One, IDTF)
                                            Store (0x03, P80H)
                                            Store (0x33, P80H)
                                            Store (One, ^^PCI0.LPCB.EC.ECTB)
                                            ^^AC.ADJP (Zero)
                                            If (LEqual (^^PCI0.LPCB.EC.NFAN, One))
                                            {
                                                ^^AC.ADJP (0x40000006)
                                            }
                                        }
                                        ElseIf (LEqual (_T_6, 0x05))
                                        {
                                            Store (Local2, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD5, ^^PCI0.LPCB.EC.FCMD)
                                            Store (One, IDTF)
                            ...
                            ElseIf (LEqual (_T_4, 0x18))
                            {
                                If (^^PCI0.LPCB.EC.ECOK)
                                {
                                    While (One)
                                    {
                                        Store (ToInteger (Local2), _T_7)
                                        If (LEqual (_T_7, Zero))
                                        {
                                            Store (Zero, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD4, ^^PCI0.LPCB.EC.FCMD)
                                        }
                                        ElseIf (LEqual (_T_7, One))
                                        {
                                            Store (One, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD4, ^^PCI0.LPCB.EC.FCMD)
                                        }
                                        ...
                                        ElseIf (LEqual (_T_7, 0x03))
                                        {
                                            Store (0x03, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD4, ^^PCI0.LPCB.EC.FCMD)
                                        }
                                        ElseIf (LEqual (_T_7, 0x04))
                                        {
                                            Store (0x04, ^^PCI0.LPCB.EC.FDAT)
                                            Store (0xD4, ^^PCI0.LPCB.EC.FCMD)
                                        }
                            ...
                            ElseIf (LEqual (_T_4, 0x1A))
                            {
                                If (LAnd (LGreaterEqual (OSYS, 0x07DD), LEqual (HEFE, One)))
                                {
                                    If (LAnd (Local2, One))
                                    {
                                        If (^^PCI0.LPCB.EC.ECOK)
                                        {
                                            Or (^^PCI0.LPCB.EC.AIRP, 0x40, ^^PCI0.LPCB.EC.AIRP)
                                        }
                                    }
                                    ElseIf (^^PCI0.LPCB.EC.ECOK)
                                    {
                                        And (^^PCI0.LPCB.EC.AIRP, 0xBF, ^^PCI0.LPCB.EC.AIRP)
                                    }
                                }
                            }
                ...
                Method (WMBB, 3, Serialized)
                {
                    ...
                    {
                        Store (Arg1, _T_0)
                        If (LNotEqual (Match (Package (0x25)
                                        {
                                            One, 
                                            0x05, 
                                            0x06, 
                        ...
                        ElseIf (LNotEqual (Match (Package (0x26)
                                        {
                                            0x13, 
                                            0x14, 
                                            0x1D, 
                ...
                Method (_REG, 2, Serialized)  // _REG: Region Availability
                {
                    ...
                    If (LAnd (LEqual (Arg0, 0x03), LEqual (Arg1, One)))
                    {
                        ...
                        If (LEqual (LSTE, Zero))
                        {
                            ...
                            If (CondRefOf (\_SB.PCI0.GFX0.LDES))
                            {
                                Store (Zero, ^^^GFX0.LDES)
                            }

                            If (CondRefOf (\_SB.PCI0.PEG0.PEGP.LDES))
                            {
                                Store (Zero, ^^^PEG0.PEGP.LDES)
                            }
                        }
                        ...
                        If (LEqual (LSTE, One))
                        {
                            ...
                            If (CondRefOf (\_SB.PCI0.PEG0.PEGP.LDES))
                            {
                                Store (One, ^^^PEG0.PEGP.LDES)
                            }
                        }

                        While (One)
                        {
                            Store (ToInteger (^^^PEG0.PEGP.PDID), _T_0)
                            If (LEqual (_T_0, 0x1BB8))
                            {
                                Store (Zero, MAXQ)
                            }
                            ElseIf (LEqual (_T_0, 0x1BB7))
                            {
                                Store (One, MAXQ)
                            }
                            ElseIf (LEqual (_T_0, 0x1BA1))
                            {
                                Store (One, MAXQ)
                            }
                            ElseIf (LEqual (_T_0, 0x1C20))
                            {
                                Store (Zero, MAXQ)
                            }
...
Store (0x50, P80H)
                    Store (OEM4, Local0)
                    If (LEqual (Local0, 0x74))
                    {
                        \rmdt.p1("EC _Q50 0x74")
                        If (^^^^WMI.HKDR)
                        {
                            Store (0x74, ^^^^WMI.EVNT)
                            Notify (WMI, 0xD0)
...
Store (0x51, P80H)
                    If (And (NVBB, 0xFFFF))
                    {
                        ...
                        Or (And (ShiftLeft (Local1, 0x04), 0xF0), And (Local2, 0x0F), Local0)
...
\rmdt.p1("EC _Q56 exit")
        ...
        Scope (\_SB.PCI0.LPCB)
        {
            ...
            Device (SYNM)
            {
                Method (_HID, 0, NotSerialized)  // _HID: Hardware ID
                {
                    OperationRegion (GDW0, SystemMemory, 0xDF4104E0, One)
                    Field (GDW0, ByteAcc, Lock, Preserve)
                    {
                        CCS,    8
                    }
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                Buffer (0x10)
                {
                    ...
                    /* 0008 */  0x01, 0x0C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS03)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                ...
                {
                    /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                    /* 0008 */  0x03, 0x0C, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS04)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                ...
                {
                    /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                    /* 0008 */  0x05, 0x0C, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS07)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                Buffer (0x10)
                {
                    /* 0000 */  0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x68,
                    /* 0008 */  0x00, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
        }
    ...
    Scope (_SB.PCI0.XHC.RHUB.HS09)
    {
        ...
        Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
        {
            Name (PLDP, Package (0x01)
            {
                Buffer (0x10)
                {
                    /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x01,
                    /* 0008 */  0x68, 0x0C, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00 
                }
            })
            Return (PLDP)
            ...
            Device (SS01)
            {
                ...
                Method (_PLD, 0, NotSerialized)  // _PLD: Physical Location of Device
                {
                    Name (PLDP, Package (0x01)
                    {
                        ...
                        {
                            /* 0000 */  0x01, 0xC6, 0x72, 0x00, 0x00, 0x00, 0x00, 0x01,
                            /* 0008 */  0x61, 0x0C, 0x80, 0x04, 0x00, 0x00, 0x00, 0x00 
                        }
                    })
                    Return (PLDP)
                }
